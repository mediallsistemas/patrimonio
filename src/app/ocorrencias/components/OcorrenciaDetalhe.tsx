...
export default function OcorrenciaDetalhe({
  ...
  // índice da ocorrência que está abrindo o seletor de bem (-1 = fechado)
  const [bemModalIdx, setBemModalIdx] = useState(-1)

  function abrirBemModal(i: number) {
    setBemModalIdx(i)
  }

  function fecharBemModal() {
    setBemModalIdx(-1)
  }
        ...
        <div className="space-y-6">
          {estado.detalhes.map((detalhe, i) => (
            <div key={i} className="space-y-4">
              ...
              {/* Bem patrimônio — aparece quando tipo = patrimonio */}
