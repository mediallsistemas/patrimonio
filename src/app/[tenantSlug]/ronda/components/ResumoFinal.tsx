...
import { type BlocoAPI, type DraftEstado } from '../ronda.types'
...
export default function ResumoFinal({ tenantSlug, estado, blocos, totalFeitos, feitosNoBloco, resetar }: ResumoFinalProps) {
  ...
  return (
    <Card shadow="md">
      ...
      <div className="space-y-3">
        ...
        <Button
          variant="outline"
          onClick={() => router.push(`/${tenantSlug}/ronda/historico`)}
          className="w-full"
        >
