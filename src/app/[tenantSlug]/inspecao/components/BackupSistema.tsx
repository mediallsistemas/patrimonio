...
import type { Medicoes } from '../inspecao.types'

interface Props {
  ambiente: string
  medicoes: Medicoes
  onBackup: (ligado: boolean) => void
  onVoltar: () => void
}

export default function BackupSistema({ ambiente, medicoes, onBackup, onVoltar }: Props) {
  return (
    <Card shadow="md">
