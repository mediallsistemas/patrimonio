...
interface GasesBackupProps {
  estado: DraftEstado
  atualizar: (parcial: Partial<DraftEstado>) => void
}

export default function GasesBackup({ estado, atualizar }: GasesBackupProps) {
  return (
    <Card shadow="md">
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <button
          onClick={() => atualizar({ backupLigado: true, etapa: 'gases_abastecimento' })}
        ...
        <button
          onClick={() => atualizar({ backupLigado: false, etapa: 'gases_abastecimento' })}
