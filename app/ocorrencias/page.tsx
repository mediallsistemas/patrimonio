    ...
    <div className="form-bg min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex items-start justify-center px-4 py-6">
        <div className="w-full max-w-lg space-y-4">
          ...
          {/* Barra de progresso — 1 segmento por bloco */}
          ...
          {etapa === 'ocorrencia_pergunta' && (
            <Card shadow="md">
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <button onClick={handleSemOcorrencia} disabled={submitting}
                ...
                <button onClick={() => setEtapa('ocorrencia_detalhe')}
          ...
          {etapa === 'ocorrencia_detalhe' && (
            <Card shadow="md">
              <Text variant="caption" className="text-gray-300 uppercase tracking-wide font-semibold block mb-1">{blocoAtual.bloco}</Text>
                ...
                <div className="space-y-2">
                  ...
                  {detalhe.foto ? (
                    <div className="relative rounded-xl overflow-hidden border border-gray-200">
                      ...
                      <button type="button" onClick={() => setDetalhe((d) => ({ ...d, foto: null }))} className="absolute top-2 right-2 bg-dark/70 text-white rounded-full p-1">
                        <X className="w-4 h-4" />
                      </button>
                    </div>
                  ) : (
          ...
          {etapa === 'bloco_resumo' && (
            <Card shadow="md">
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  <Text as="h2" variant="heading-sm" className="text-dark block">{blocoAtual.bloco} concluído</Text>
                  <Text variant="body-sm" className="text-gray-300 block">
              ...
              {!isUltimoBloco ? (
                <div className="space-y-2">
                  <div className="px-3 py-2.5 rounded-xl bg-teal-50 border border-teal-200 mb-2 text-sm font-sans text-teal-700">
                    <strong>Próximo:</strong> {BLOCOS_AMBIENTES[blocoIdx + 1].bloco}
          ...
          {etapa === 'resumo_final' && (
            <Card shadow="md">
              ...
              <div className="space-y-2 mb-6">
                {BLOCOS_AMBIENTES.map((b, i) => {
                  const comOcor = concluidos.filter((c) => c.blocoIdx === i && c.temOcorrencia).length
                  return (
              ...
              <div className="space-y-3">
                <Button onClick={() => { setRondaId(null); setBlocoIdx(0); setAmbienteIdx(0); setConcluidos([]); resetDetalhe(); setEtapa('inicio') }} className="w-full">
                  Nova ronda
                </Button>
