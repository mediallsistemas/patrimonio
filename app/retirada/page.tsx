...
export default function RetiradaPage() {
  ...
  async function confirmarRetirada() {
    ...
    setConfirmando(true)
    try {
      await api.post('movimentacoes', { pessoaId: pessoa.id, tipo: 'retirada' })
      setEstado('sucesso')
    } catch (err: unknown) {
            ...
            <Card shadow="md" padding="lg">
              <div className="text-center space-y-5">
                ...
                <div className="bg-gray-50 rounded-xl p-4 text-left border border-gray-200">
                  <Text variant="body-sm" className="text-gray-300 block mb-1">
                    Data de retirada
                  </Text>
                  <Text as="p" variant="body-md-bold" className="text-dark">
                    {dataFormatada} · {horaFormatada}
                  </Text>
                </div>
                <Text variant="body-md" className="text-gray-300 block">
                  Deseja confirmar a retirada?
                </Text>
          ...
          {estado === 'nao_encontrado' && (
            <Card shadow="md" padding="lg">
              <div className="text-center space-y-5">
                ...
                <Text variant="body-md" className="text-gray-300 block">
                  Você não está cadastrado no sistema. Deseja criar um cadastro?
                </Text>
                <div className="flex gap-3">
                  <Button
                    variant="outline"
