import { MapPin, Play, History } from 'lucide-react'
...
export default function TelaInicial({ tenantSlug, totalAmbientes, loadingAmbientes, onIniciar }: Props) {
  return (
    <Card shadow="md">
      ...
      <Button onClick={onIniciar} className="w-full" disabled={loadingAmbientes || totalAmbientes === 0}>
