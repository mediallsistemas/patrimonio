            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <Text variant="body-sm-bold" className="text-dark block">
                    Foto / Face ID
                  </Text>
                </div>
                ...
                {faceDescriptor ? (
                  <div className="flex items-center gap-3 p-4 bg-green-light rounded-xl border border-gray-200">
                    ...
                    <Text variant="body-sm" className="text-green-dark flex-1">
                      Face capturada com sucesso
                    </Text>
                    <button
                      type="button"
                      onClick={() => {
                      ...
                      className="text-xs text-gray-300 hover:text-dark font-sans underline"
                    >
                      Recapturar
                    </button>
                  </div>
                  ...
                  <div className="space-y-3">
                    <CameraView
                      ...
                      label="Posicione seu rosto e aguarde..."
                    />
                    <Button
                      type="button"
                      variant="outline"
                ...
                {errors.face && (
                  <Text variant="caption" className="text-red-base block">
                    {errors.face}
                  </Text>
                )}
              </div>
